...
public class EndGamifiedLesson extends GamifiedTest2Q2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(EndGamifiedLesson.this, MainActivity.class);
        ...
        noButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EndGamifiedLesson.this, GamifiedTest2Q2.class);
                startActivity(intent);
    ...
    private void stopAndResetTimer() {
        ...
        Log.i(MYDEBUG, "Gamified Test 2 Timer. Elapsed time: " + elapsedTimeFormatted);
