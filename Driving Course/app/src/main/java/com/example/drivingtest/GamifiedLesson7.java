...
public class GamifiedLesson7 extends GamifiedLesson6 {
    ...
    Runnable timerRunnable = new Runnable() {
        @Override
        public void run() {
            if (!Timer.isTimerRunning(GamifiedLesson7.this)) {
                timerHandler.removeCallbacks(this);
                return;
            }

            long millis = System.currentTimeMillis() - Timer.getStartTime(GamifiedLesson7.this);
    ...
    */
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gamified_lesson_7);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GamifiedLesson7.this, GamifiedLesson8.class);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(GamifiedLesson7.this, GamifiedLesson6.class);
                startActivity(intent);
    ...
    private void loadVideo() {
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.parallel;
