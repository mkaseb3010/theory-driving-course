...
public class startTest1Traditional extends TraditionalLesson3{
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.start_test1_traditional);
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(startTest1Traditional.this, startTest1TraditionalSure.class);
        ...
        noButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(startTest1Traditional.this, TraditionalLesson3.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void stopAndResetTimer() {
        ...
        Log.i(MYDEBUG, "Lesson 1 Traditional Timer. Elapsed time: " + elapsedTimeFormatted);
