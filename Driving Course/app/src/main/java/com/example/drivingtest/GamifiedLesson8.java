...
public class GamifiedLesson8 extends GamifiedLesson7 {
    ...
    Runnable timerRunnable = new Runnable() {
        @Override
        public void run() {
            if (!Timer.isTimerRunning(GamifiedLesson8.this)) {
                timerHandler.removeCallbacks(this);
                return;
            }

            long millis = System.currentTimeMillis() - Timer.getStartTime(GamifiedLesson8.this);
    ...
    */
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gamified_lesson_8);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GamifiedLesson8.this, StartTest2Gamified.class);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(GamifiedLesson8.this, GamifiedLesson7.class);
                startActivity(intent);
    ...
    private void loadVideo() {
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.all_way_stop;
