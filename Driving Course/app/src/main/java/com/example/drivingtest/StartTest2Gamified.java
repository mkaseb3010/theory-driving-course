...
public class StartTest2Gamified extends GamifiedLesson8 {
   ...
   */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.start_test2_gamified);
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(StartTest2Gamified.this, StartTest2GamifiedSure.class);
        ...
        noButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(StartTest2Gamified.this, GamifiedLesson6.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void stopAndResetTimer() {
        ...
        Log.i(MYDEBUG, "Lesson 2 Gamified Timer. Elapsed time: " + elapsedTimeFormatted);
