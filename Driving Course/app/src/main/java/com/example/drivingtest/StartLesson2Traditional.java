...
public class StartLesson2Traditional extends TraditionalTest1Q3{
   ...
   */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(StartLesson2Traditional.this, EndTraditionalTest1Sure.class);
    ...
    private void stopAndResetTimer() {
        ...
        Log.i(MYDEBUG, "Traditional Test 1 Timer. Elapsed time: " + elapsedTimeFormatted);
