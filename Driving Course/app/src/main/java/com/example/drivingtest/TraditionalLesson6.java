...
public class TraditionalLesson6 extends TraditionalLesson5{
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.traditional_lesson_6);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TraditionalLesson6.this, startTest2Traditional.class);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TraditionalLesson6.this, TraditionalLesson5.class);
                startActivity(intent);
