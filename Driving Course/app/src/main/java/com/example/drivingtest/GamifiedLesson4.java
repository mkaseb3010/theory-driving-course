...
public class GamifiedLesson4 extends GamifiedLesson3{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gamified_lesson_4);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GamifiedLesson4.this, GamifiedLesson5.class);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(GamifiedLesson4.this, GamifiedLesson3.class);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_out_left, R.anim.slide_in_right);
            }
        });

        //Detectes the gesture and hand movements on the screen
    ...
    private void loadVideo() {
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.noentry;
