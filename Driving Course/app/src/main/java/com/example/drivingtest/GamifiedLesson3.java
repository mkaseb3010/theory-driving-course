...
public class GamifiedLesson3 extends GamifiedLesson2{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gamified_lesson_3);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GamifiedLesson3.this, GamifiedLesson4.class);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(GamifiedLesson3.this, GamifiedLesson2.class);
                startActivity(intent);
    ...
    private void loadVideo() {
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.no_passing;
