...
public class EndTraditionalTest1Sure extends StartLesson2Traditional {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.end_test1_traditional_sure);
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(EndTraditionalTest1Sure.this, TraditionalLesson4.class);
        ...
        noButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EndTraditionalTest1Sure.this, TraditionalTest1Q1.class);
                startActivity(intent);
    ...
    private void startTimer() {
        ...
        if (timerRunnable == null) {
            timerRunnable = new Runnable() {
                @Override
                public void run() {
                    if (Timer.isTimerRunning(EndTraditionalTest1Sure.this)) {
                        long elapsedMillis = System.currentTimeMillis() - Timer.getStartTime(EndTraditionalTest1Sure.this);
