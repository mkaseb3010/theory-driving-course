...
public class TraditionalTest1Q1 extends startTest1Traditional {
    ...
    Runnable timerRunnable = new Runnable() {
        ...
        @Override
        public void run() {
            if (!Timer.isTimerRunning(TraditionalTest1Q1.this)) {
                timerHandler.removeCallbacks(this);
                return;
            }

            long millis = System.currentTimeMillis() - Timer.getStartTime(TraditionalTest1Q1.this);
   ...
   */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.traditional_test1_q1);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TraditionalTest1Q1.this, TraditionalTest1Q2.class);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TraditionalTest1Q1.this, startTest1TraditionalSure.class);
                startActivity(intent);
            }
        });
    ...
    private void validateAnswers() {
        ...
        if (selectedId == R.id.radioButton1) {
            ...
            if (selectedRadioButton != null) {
                ...
                Log.i(MYDEBUG, "You've answered Test 1 Question 1 incorrectly " + wrongAnswerCounter + " times.");
            }
